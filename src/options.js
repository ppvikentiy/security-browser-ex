...
const STATS_SUB_LABELS = {
  ...
  device: {
    ...
    navigator_mediaDevices_hidden: "Функция: доступ к камере/микрофону ограничен",
    mediaDevices_enumerateDevices_empty: "Функция: enumerateDevices → без cam/mic",
    mediaDevices_enumerateDevices_filtered: "Функция: enumerateDevices → без cam/mic (динамики оставлены)",
