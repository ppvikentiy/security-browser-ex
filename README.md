...
![Popup: Quick actions](./a.png)

![Options: Excluded domains](./b.png)

![Options: Focus blocker](./c.png)

![Options: Anti-fingerprint](./d.png)

![Options: Active internet protection](./e.png)
